...
- Supports GeneratePress Premium Elements (`gp_elements`) in the editor box and batch translator, including GeneratePress and GenerateBlocks metadata/CSS copying.
